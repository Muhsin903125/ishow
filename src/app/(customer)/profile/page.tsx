        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6 mb-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-orange-500 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-orange-400 disabled:opacity-50 transition-colors"
            >
