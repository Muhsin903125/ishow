                ...
                {step === 0 && (
                  <div className="h-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {(goalTypes.length > 0 ? goalTypes : [
                        { slug: "weight_loss", name: "Weight Loss", description: "Lose fat & tighten up" },
                        { slug: "muscle_gain", name: "Muscle Gain", description: "Hypertrophy focus" },
                        { slug: "athletic", name: "Athletic Performance", description: "Speed & explosiveness" },
                        { slug: "general", name: "General Health", description: "Moving better daily" },
                      ]).map((g) => {
                        // Handle both DB and fallback structure
                        const slug = (g as any).slug || (g as any).value;
